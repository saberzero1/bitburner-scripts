...
const argsSchema = [ // The set of all command line arguments
    ...
    ['disable-bladerunner', player.bitNodeN == 12],
...
function manageReservedMoney(ns, player, stocksValue) {
    ...
    const currentReserve = Number(ns.read("reserve.txt") || 0);
    if (reserveForDaedalus || (currentReserve == 100E9 && !player.factions.includes("Daedalus"))) // Reserve 100b to get the daedalus invite
