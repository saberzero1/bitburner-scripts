...
export async function main(ns) {
    let scan = (server, parent) =>
        ns
            .scan(server)
            .map((newServer) =>
                newServer != parent ? scan(newServer, server) : server,
            )
            .flat();
